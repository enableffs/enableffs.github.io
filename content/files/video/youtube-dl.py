...
videos.append(Video("owxORyUdYec", "vision"))       # A blind taylor trains  learners with visual impairment
videos.append(Video("9hLupgYcHqU", "vision"))       # Blind  learners learn to use computers
videos.append(Video("abapaB5Dvgk", "dual"))         # Deafblind  learners at Kilimani Deafblind Unit in Nairobi
...
videos.append(Video("viFMjSzrI6o", "hearing"))      # Information about sexual issues for deaf  learners
videos.append(Video("2OI3-qMk_1I", "hearing"))      # Deaf children make sandwiches
videos.append(Video("XcyaN7ayLkE", "hearing"))      # Vocational training deaf  learners
